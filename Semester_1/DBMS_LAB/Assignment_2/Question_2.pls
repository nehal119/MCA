...
INSERT INTO SOFTWARE(PNAME, TITLE, DEVIN, SCOST, DCOST, SOLD)
VALUES('Vivek', 'Google Map 2', 'PYTHON', 2500, 20000, 200);
INSERT INTO SOFTWARE(PNAME, TITLE, DEVIN, SCOST, DCOST, SOLD)
VALUES('Jatin', 'Health Tracker 2', 'JAVASCRIPT', 900, 60000, 40);
INSERT INTO SOFTWARE(PNAME, TITLE, DEVIN, SCOST, DCOST, SOLD)
VALUES('Rakesh', 'Online Portal 2', 'C#', 1000, 30000, 6000);
INSERT INTO SOFTWARE(PNAME, TITLE, DEVIN, SCOST, DCOST, SOLD)
VALUES('Rakesh', 'Online Portfolio 2', 'Oracle', 500, 35000, 500);
INSERT INTO SOFTWARE(PNAME, TITLE, DEVIN, SCOST, DCOST, SOLD)
VALUES('Saurabh', 'Student Record 2', 'PHP', 4050, 40500, 21);
...
SELECT PNAME, MAX(DCOST) FROM SOFTWARE GROUP BY PNAME;
-- SELECT PNAME, DCOST FROM SOFTWARE WHERE PNAME ()
-- SELECT MAX(DCOST) FROM SOFTWARE S 
-- WHERE PNAME = (SELECT PNAME FROM PROGRAMMER P WHERE S.PNAME = P.PNAME);

-- 32.Produce the following output for all the male programmers => Mr. Arvind – has 15 years of experience
SELECT CONCAT(CONCAT(CONCAT(CONCAT('Mr. ', PNAME), ' - has '), TRUNC(TO_NUMBER(SYSDATE - TO_DATE(DOJ)) / 365.25)), ' years of experience') AS experience FROM PROGRAMMER;
-- SELECT LISTAGG(CONCAT(CONCAT(PNAME,','),SAL),'|') WITHIN GROUP (ORDER BY PNAME) AS CONCATDATA FROM PROGRAMMER
